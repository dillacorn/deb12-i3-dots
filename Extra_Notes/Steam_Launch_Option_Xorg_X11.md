...
gamemoderun xrandr --output DisplayPort-1 --mode "1400x1050_240" ; %command% ; xrandr --output DisplayPort-1 --mode 1920x1080 --rate 240; SettingsDX12.json +mat_letterbox_aspect_goal 0 +mat_letterbox_aspect_threshold 0 +building_cubemaps "1" -novid -freq 240 +fps_max unlimited
